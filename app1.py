...
if selected == 'HomePage':
    ...
    # STEP 1
    st.markdown("<h2 style='text-align: center; color: black;text-decoration: underline;'>STEP 1 </h2>",
                unsafe_allow_html=True)
    ...
    # STEP 2
    st.markdown("<h2 style='text-align: center; color: black;text-decoration: underline;'>STEP 2 </h2>",
                unsafe_allow_html=True)
    ...
    # STEP 3
    st.markdown("<h2 style='text-align: center; color: black;text-decoration: underline;'>STEP 3 </h2>",
                unsafe_allow_html=True)
    ...
    st.markdown(
      "<h2 style='text-align: center; color: white; background-color: green;'>THANK YOU FOR VISITING US</h2>",
       unsafe_allow_html=True
    )
    st.markdown("<br>", unsafe_allow_html=True)
...
if selected == 'Lung Cancer Prediction':
    ...
    if st.button('Lung Test Result'):
        ...
        lung_prediction = lung_model.predict([user_input])

        if lung_prediction[0] == 1:
            lung_diagnosis = 'The person has lung disease'
        else:
            lung_diagnosis = 'The person doesn\'t have lung disease'
...
if selected == "Liver Disease Prediction":
    ...
    with col1:
        Age = st.text_input('Insert Patients age :')

    # with col2:
    #     Gender = st.text_input('Insert patients gender :')

    with col2:
        Total_Bilirubin = st.text_input('Insert total bilirubin :')

    with col3:
        Direct_Bilirubin = st.text_input('Insert Direct_Bilirubin :')

    with col1:
        Alkaline_Phosphotase = st.text_input('Insert Alkaline_Phosphotase :')

    with col2:
        Alamine_Aminotransferase = st.text_input('Insert Alamine_Aminotransferase :')

    with col3:
        Aspartate_Aminotransferase = st.text_input('Insert Aspartate_Aminotransferase :')

    with col1:
        Total_Protiens = st.text_input('Insert Total_Protiens :')

    with col2:
        Albumin = st.text_input('Insert Albumin :')

    with col3:
        Albumin_and_Globulin_Ratio = st.text_input('Insert Albumin_and_Globulin_Ratio :')

    # code for Prediction
    liver_diagnosis = ''

    # creating a button for Prediction
    if st.button("Liver Disease Prediction Test Result"):
        ...
        Liver_Disease_Prediction = liver_model.predict([user_input])
